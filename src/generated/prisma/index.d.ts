...
export namespace Prisma {
  ...
  */
  ...
  export type BirthdayOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "day" | "month" | "name" | "title" | "userId", ExtArgs["result"]["birthday"]>
  ...
  interface BirthdayFieldRefs {
    ...
    readonly title: FieldRef<"Birthday", 'String'>
  ...
  export type BirthdayWhereInput = {
    ...
    title?: StringFilter<"Birthday"> | string
  ...
  export type BirthdayScalarWhereWithAggregatesInput = {
    ...
    title?: StringWithAggregatesFilter<"Birthday"> | string
